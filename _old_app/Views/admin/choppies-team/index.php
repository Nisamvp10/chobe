    ...
    <div class="flex items-center justify-between">
        <div class="col-lg-12">
            <div class="d-flex justify-content-between align-items-center mb-0">
                ...
                <div>
                    <a href="<?= base_url('choppies-team/create') ?>" class="btn btn-primary">
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden p-4">
        <div class="flex flex-col md:flex-row gap-4 mb-6">
            ...
            <div class="flex-1 relative">
                ...
                <input id="searchInput" type="text" placeholder="Search staff by name, email" class="pl-10 pr-3 py-2 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
            </div>
...
<?= $this->section('scripts') ?>
 ...
 loadClients();
            function loadClients(search = '') {
                ...
                $.ajax({
                    url: "<?= site_url('choppies-team/list') ?>",
                    type: "POST",
                                            ...
                                            <div class="flex-1">
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <div class="flex space-x-1">
                                                        <a href="<?=base_url('choppies-team/edit/');?>${user.encrypted_id}" class="p-1 text-gray-500 hover:text-primary-600 transition-colors">
