   ...
   <div class="bg-white rounded-lg p-6 w-full max-w-md">
      ...
      <form id="rolemasterForm" method="post" >
         ...
         <div class="flex justify-end gap-3">
            <button type="button" data-close="categoryModal" class="px-4 py-2 text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50">Cancel</button>
            <button id="submitBtn" class="bg-primary hover:bg-primary-700 text-white px-4 py-2 rounded-2 flex items-center transition-colors">
