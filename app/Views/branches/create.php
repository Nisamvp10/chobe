...
<?php
    if(!empty($data))
    {
        ...
        $rmname = $data['rm_store'];
        $rm_mail = $data['rm_mail'];
        $oldstore = $data['oldstore_name'];
        $storemail = $data['store_mailid'];
        $polaris_code = $data['polaris_code'];
        $oracle_code = $data['oracle_code'];
    }else{
        $id=$branch=$location = $rmname=$rm_mail=$oldstore=$storemail=$polaris_code=$oracle_code ='';
    }
?>
 <!-- titilebar -->
...
<div class="bg-white rounded-lg shadow-sm overflow-hidden p-4">
    <form id="branchCreate" method="post">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="space-y-4">
                <div >
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="branch" value="<?=$branch;?>"  id="branch" class="pl-10 pr-3 py-2 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Enter Your Store Name">
                ...
                <div >
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="location" value="<?=$location;?>"  id="location" class="pl-10 pr-3 py-2 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Enter Your Location">
                   ...
                   <div >
                    ...
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 mt-2 items-center pointer-events-none"><i class="bi bi-window text-xl text-gray-400"></i></div>
                        <input type="text" name="rmname" value="<?=$rmname;?>"  id="rmname" class="pl-10 pr-3 py-2 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Enter RM Mail ID">
                        <div class="invalid-feedback" id="branch_error"></div>
                    </div>
                </div>
                   <div >
                    <label class="block text-sm font-medium text-gray-700 mb-1">Rm Mail Id</label>
                    <div class="relative">
                        ...
                        <input type="email" name="rm_mail" value="<?=$rm_mail;?>"  id="rm_mail" class="pl-10 pr-3 py-2 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Enter RM Name">
                        <div class="invalid-feedback" id="branch_error"></div>
                    </div>
                </div>
            ...
            <div class="space-y-4">
                <div >
                    <label class="block text-sm font-medium text-gray-700 mb-1">Old Store Name</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 mt-2 items-center pointer-events-none"><i class="bi bi-shop-window text-xl text-gray-400"></i></div>
                        <input type="text" name="oldstore" value="<?=$oldstore;?>"  id="oldstore" class="pl-10 pr-3 py-2 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Enter Old Store Name">
                        <div class="invalid-feedback" id="branch_error"></div>
                    </div>
                </div>
                <div >
                    <label class="block text-sm font-medium text-gray-700 mb-1">Store Mail Id</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 mt-2 items-center pointer-events-none"><i class="bi bi-envelope text-xl text-gray-400"></i></div>
                        <input type="email" name="storemail" value="<?=$storemail;?>"  id="storemail" class="pl-10 pr-3 py-2 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Enter Store Mail ID">
                        <div class="invalid-feedback" id="branch_error"></div>
                    </div>
                </div>
                   ...
                   <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="polaris_code" value="<?=$polaris_code;?>"  id="polaris_code" class="pl-10 pr-3 py-2 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Enter Polaris ">
                                <div class="invalid-feedback" id="branch_error"></div>
                            </div>
                        </div>
                         ...
                         <div>
                            ...
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 mt-2 items-center pointer-events-none"><i class="bi bi-hash text-xl text-gray-400"></i></div>
                                <input type="number" name="oracle_code" value="<?=$oracle_code;?>"  id="oracle_code" class="pl-10 pr-3 py-2 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Enter Oracle Code">
                                <div class="invalid-feedback" id="branch_error"></div>
                            </div>
                        </div>
