    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden p-4">
        <div class="flex flex-col md:flex-row gap-4 mb-6">
            ...
            <div class="flex-1 relative">
                ...
                <input type="text" id="searchInput" placeholder="Search client name, or Phone Number or Email..." class="pl-10 pr-3 py-2 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
            </div>
            
            <!-- Column 2: Status Dropdown -->
            <div class="w-full md:w-48 d-none">
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
...
<?= view('modal/deletePopup');?>
<?= $this->endSection(); ?>
<?= $this->section('scripts') ?>
    <script src="<?=base_url('public/assets/js/actions.js') ;?>" ></script>
