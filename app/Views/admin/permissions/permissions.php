...
?>
 ...
 <div class="flex items-center justify-between">
    <div class="flex items-center gap-4">
        <a href="<?=base_url('categories');?>" class="p-2 rounded-lg hover:bg-gray-100 transition-colors">
        ...
        <div class="w-full md:w-48 gap-4 grid grid-cols-1 mb-3"> 
            ...
            <?php if(haspermission(session('user_data')['role'],'create_permissions')) { ?>
             <div class="mt-8 flex justify-end gap-3 mt-3">
                    ...
                    <button id="submitBtn" class="bg-blue-600 hover:bg-primary-700 text-white px-4 py-2 rounded-md flex items-center rounded-2 transition-colors"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-save mr-1"><path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"></path><polyline points="17 21 17 13 7 13 7 21"></polyline><polyline points="7 3 7 8 15 8"></polyline></svg>Save</button>
                </div>
                <?php } ?>
            <!-- 2 -->
        ...
        if (permissions === 0) {
            ...
            html += `
                    <div class="text-center py-8">
                        <h3 class="text-lg font-medium text-gray-700">No Item Found found</h3>
            ...
            permissions.forEach(permission => {
                ...
                html += ` <div class="bg-white border border-gray-200 rounded-lg p-2 hover:shadow-md transition-shadow cursor-pointer">
                            <h4 class="!text-sm font-medium text-gray-200 capitalize">${permission.permission_name.replaceAll('_', ' ')} </h4>
