          ...
          <!-- <input type="text" name="title" class="w-full border px-3 py-2 rounded" id="title" />
           ...
           <?php if(!empty($masterTasks)) { ?>
                     <div class="w-full ">
                        ...
                        <select id="masetrTask" name="masetrTask" class="pl-3 pr-3 py-2 w-full activity-tasks border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
