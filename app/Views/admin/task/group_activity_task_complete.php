...
?>
 ...
 <div class="flex items-center justify-between ">
    <div class="flex items-center gap-4">
        <a href="<?=base_url('tasks');?>" class="p-2 rounded-lg hover:bg-gray-100 transition-colors">
...
<div class="bg-white rounded-lg shadow-sm overflow-hidden p-4">
    <form id="commentActivities" method="post">
        <?= csrf_field() ?>
        ...
        <div class="w-full">
            ...
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3 mt-2 items-center pointer-events-none">
                    ...
                    <select class="w-full border !pl-10 px-4 py-2 rounded" id="activities" name="activities">
                        <option value="">Choose Activity</option>
                    </select>
                    <div class="invalid-feedback" id="activities_error"></div>
                </div>
            </div>
            ...
            <div class="w-full">
                ...
                <div class="relative">
                    ...
                    <input type="date" value="" name="date" id="date" class="pl-10 pr-3 py-2 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Enter Date">
