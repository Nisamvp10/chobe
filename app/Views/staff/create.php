            ...
            <div class="space-y-4">
               ...
               <!-- here -->
                ...
                <div >
                    ...
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 mt-2 items-center pointer-events-none"><i class="bi bi-diagram-3 text-xl text-gray-400"></i></div>
                        <select name="project" id="project" class="pl-10 pr-3 py-2 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" >
                            <option value="" desabled>Select Project</option>
                            <?php
                                if(!empty($projects)){
